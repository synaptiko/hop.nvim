...
command! HopFForward lua require'hop'.hint_char1_line({ direction = require'hop.hint'.HintDirection.AFTER_CURSOR, start_offset = 1 })
command! HopFBackward lua require'hop'.hint_char1_line({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR, start_offset = -1 })

command! HopTForward lua require'hop'.hint_char1_line({ direction = require'hop.hint'.HintDirection.AFTER_CURSOR, start_offset = 2, jump_offset = -1 })
command! HopTBackward lua require'hop'.hint_char1_line({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR, start_offset = -2, jump_offset = 1 })
